...
def send_email(app_info,emails=None):
    ...
    def send_veri_mail():
        ...
        msg = Message(subject="Promote Your Mobile App", sender="thabo@techxolutions.com", recipients=["thabo@techxolutions.com",emails,"info@instacash.co.sz","b.dube@instacash.co.sz"])
